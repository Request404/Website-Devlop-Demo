    ...
    <div class="home-page">
      <div class="home-page-container">
        ...
        <div class="content-card">
          <h2 class="content-title">{{ $t('page.allMovies') }}</h2>
...
export default {
  ...
  methods: {
    ...
    search(keyword) {
      this.api.dMovieClientGetAllMovies(0, 0, keyword).then(rs => {
        this.productData = rs.data.data;
      })
    }
  },
  created() {
    this.api.dMovieGetWebsiteIndexMovies(1).then(rs => {
      this.carouselData = rs.data.data;
    })
    this.api.dMovieClientGetAllMovies(0, 0, 0).then(rs => {
      this.productData = rs.data.data;
    })
  }
}
